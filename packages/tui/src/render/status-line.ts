...
import { formatStatusIcon, type ToolUIStatus } from "./render-utils";

/** Status icon, title, description, and metadata for a single header row. */
...
/** Render a single-line status header, flattening multiline fields. */
