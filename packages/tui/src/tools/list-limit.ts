...
/** Items retained after applying output limits and their metadata. */
...
/** Limits applied to result lists and display previews. */
...
/** Apply result and preview limits while retaining truncation metadata. */
